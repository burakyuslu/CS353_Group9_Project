    ...
    <v-row no-gutters>
      <v-col>
        <v-card
          ...
          tile
        >
          The Complete Web Developer in 2021: Zero to Mastery <br> Learn to code and become a Web Developer in 2021 with HTML, CSS, Javascript, React, Node.js, Machine Learning & more!
        </v-card>
      </v-col>
      <v-col order="12">
        <v-card
          ...
          tile
        >
          4.7/5.0 <br> (46,766 ratings) <br> 158,605 students
        </v-card>
      </v-col>
      <v-col order="1">
        <v-card
          class="pa-5"
        >
          The price of the course is $123
          <br>
          <v-btn>BUY NOW</v-btn>
          <br>
    ...
    <v-row no-gutters>
      <v-col>
        <v-card
          ...
          tile
        >
          Lectures -LIST- COMPONENT WILL COME
        </v-card>
      </v-col>
      <v-col order="12">
        <v-card
